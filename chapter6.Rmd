...
可別跟用單一個中括號 `[ ]` 從向量中選擇元素搞混了，你可以在R Console中快速輸入並檢視結果！
...
你跟幾個電影愛好者分享了你建立的清單，其中一個叫M. McDowell的資深成員跟你說你忘了把上映年份這個重要資訊放入，基於對自我的高標準要求，你決定要把這個遺漏的資訊加入清單中。 
